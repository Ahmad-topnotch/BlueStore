...
export default function CartScreen() {
  ...
  const handleCheckout = () => {
    ...
    router.push({
      ...
      params: { 
        totalAmount: totalPrice, // Key synchronized for the flow
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}><Text style={styles.headerTitle}>My Shopping Cart</Text></View>
      <FlatList
        data={cartItems}
...
const styles = StyleSheet.create({
  ...
  header: { paddingTop: 20, paddingBottom: 20, backgroundColor: '#fff', alignItems: 'center', borderBottomWidth: 1, borderBottomColor: '#f1f5f9' },
  headerTitle: { fontSize: 20, fontWeight: 'bold', color: '#1e293b' },
  cartCard: { flexDirection: 'row', backgroundColor: '#fff', borderRadius: 15, padding: 12, marginBottom: 15, alignItems: 'center', elevation: 2 },
  ...
  checkoutBtn: { backgroundColor: '#3498db', flexDirection: 'row', padding: 18, borderRadius: 15, alignItems: 'center', height: 60, justifyContent: 'center' },
